...
for(i in 1:size){
  if(ANNOVAR_ensembl_Gene_ID[i] == "."){
    z <- append(z, ANNOVAR_ensembl_Closest_gene.intergenic_only.[i])
  }else{
    z <- append(z, ANNOVAR_ensembl_Gene_ID[i])
  }
}
...
SN_ID <- str_extract_all(SnpEff_ensembl_Gene_ID, "ENSG...........", simplify = TRUE) # matrix for IDs
